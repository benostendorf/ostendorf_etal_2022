---
title: "Validation cohort #2 (young female mice) for dissociated lungs in APOE-knock-in mice"
...
## Import data
A DESeq2 object for import can be found [here](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE200132).  
